...
public class SceneCaveToMenu : MonoBehaviour
{
    ...
    IEnumerator OnTriggerEnter(Collider col)
    {
        ...
        if (col.gameObject.tag == TrackerID)
        {
            ...
            SceneManager.LoadScene("MainMenu");      // *** Change the LoadScene(" ") to appropriate scene. *** //
        }
