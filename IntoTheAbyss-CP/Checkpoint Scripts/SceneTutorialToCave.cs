/*
    ----------------------------------------------------------------------------------------------
    FILE NAME: SceneTutorialToCave.cs
    ...
    SCENE FOR: Intro-Tutorial-Scene
    SCENE TO:  EnterTheCaves
    ----------------------------------------------------------------------------------------------
*/
...
public class SceneTutorialToCave : MonoBehaviour
{
    ...
    IEnumerator OnTriggerEnter(Collider col)
    {
        ...
        if (col.gameObject.tag == TrackerID)
        {
            ...
            SceneManager.LoadScene("EnterTheCaves");      // *** Change the LoadScene(" ") to appropriate scene. *** //
        }
